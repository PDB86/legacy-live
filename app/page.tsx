...
export default function LuxuryLiveEntertainment() {
  ...
  const portfolioImages = [
    { id: 1, alt: "Fusion DJ EXP", src: "/fb1.png" },
    { id: 2, alt: "Fusion DJ EXP", src: "/fb2.png" },
    { id: 3, alt: "Fusion DJ EXP", src: "/fb3.png" },
    { id: 4, alt: "Havana South", src: "/lb1.png" },
    { id: 5, alt: "Havana South", src: "/lb2.png" },
    { id: 6, alt: "Havana South", src: "/lb3.png" },
    { id: 7, alt: "DJ Bam", src: "/djb1.png" },
    { id: 8, alt: "DJ Bam", src: "/djb2.png" },
    { id: 9, alt: "DJ Bam", src: "/djb3.png" },
    { id: 10, alt: "DJ Fever", src: "/djf1.png" },
    { id: 11, alt: "Havana South", src: "/lb7.png" },
    { id: 12, alt: "Havana South", src: "/lb8.png" },
    { id: 13, alt: "Havana South", src: "/lb9.png" },
    { id: 14, alt: "DJ Fever", src: "/djf2.png" },
    { id: 15, alt: "Fusion DJ EXP", src: "/fb4.png" },
    { id: 16, alt: "Fusion DJ EXP", src: "/fb5.png" },
    { id: 17, alt: "Fusion DJ EXP", src: "/fb6.png" },
    { id: 18, alt: "Fusion DJ EXP", src: "/fb7.png" },
    { id: 19, alt: "Fusion DJ EXP", src: "/fb8.png" },
